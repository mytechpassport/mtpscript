...
PHASE2_ACCEPTANCE_TEST_OBJS = $(PHASE2_ACCEPTANCE_TEST_SOURCES:.c=.o) mquickjs.o mquickjs_crypto.o mquickjs_effects.o mquickjs_db.o mquickjs_http.o mquickjs_log.o mquickjs_api.o mquickjs_errors.o dtoa.o libm.o cutils.o src/decimal/decimal.o src/compiler/ast.o src/compiler/lexer.o src/compiler/parser.o src/compiler/typechecker.o src/compiler/codegen.o src/compiler/openapi.o src/compiler/module.o src/compiler/mtpscript.o src/compiler/typescript_parser.o src/snapshot/snapshot.o src/stdlib/runtime.o src/host/npm_bridge.o src/cli/mtpsc.o
