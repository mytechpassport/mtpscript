...
static const uint64_t __attribute((aligned(64))) js_stdlib_table[] = {
  ...
  /* sorted atom table (offset=498) */
  JS_VALUE_ARRAY_HEADER(205),
  ...
  /* global object properties (offset=1774) */
